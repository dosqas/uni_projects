...
class MovieRepo:
    def __init__(self, rental_repo):
        ...
        for count in range(1, 21):
            self._movie_data.append(Movie(str(count), "Movie" + str(count), "Description"
    ...
    def add_movie(self, movie):
        ...
        :return: None
        """
        for movie_inlist in self._movie_data:
    ...
    def get_movie_description(self, movie_id):
        for movie in self._movie_data:
            if movie.movie_id() == movie_id:
                return movie.movie_description()
